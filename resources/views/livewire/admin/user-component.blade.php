<div class="antialiased sans-serif bg-gray-200">
  <div class="container mx-auto py-6 px-4" x-data="datatables()" x-cloak>
          ...
          <form class="px-8 pt-6 pb-8 mb-4" wire:submit.prevent="save">
            <div class="flex flex-wrap -mx-3 mb-2">
              ...
              <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                ...
                <input
                  class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                  id="email" type="email" placeholder="user@example.com" wire:model.lazy="user.email" required>
                @error('user.email')
                <span class="text-red-600">{{ $message }}</span>
                @enderror
              </div>
            ...
            <div class="flex flex-wrap -mx-3 mb-2">
              <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                ...
                <input
                  class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                  id="password" type="password" placeholder="******" wire:model.lazy="user.password" required />
                @error('user.password')
                <span class="text-red-600">{{ $message }}</span>
                @enderror
              </div>
    ...
    <div class="mb-4 flex justify-between items-center">
      ...
      {{-- Elimación masiva y Exportar --}}
      <div class="mr-2" x-show="selectedRows.length > 1">
        <div class="relative">
          <button x-on:click="showMultiOption = !showMultiOption" x-on:keydown.escape="showMultiOption = false"
        ...
        <div class="shadow rounded-lg flex">
          <div class="relative">
            <button x-on:click.prevent="open = !open"
              ...
              <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 ml-1" width="24" height="24" viewBox="0 0 24 24"
              ...
              <template x-for="heading in columns">
                <label class="flex justify-start items-center text-truncate hover:bg-gray-100 px-4 py-2">
                  <div class="text-teal-600 mr-3">
                    <input type="checkbox" class="form-checkbox focus:outline-none focus:shadow-outline" checked x-on:click="toggleColumn(heading.key)">
                  </div>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="border-dashed border-t border-gray-200 post">
              <span class="text-gray-700 px-6 py-3 flex items-center">{{ $user->posts->first()->title ?? '' }}</span>
            </td>
            ...
            <td class="border-dashed border-t border-gray-200 mr-2">
              <button class="bg-blue-500 rounded text-white px-4 py-2 hover:bg-blue-300 hover:outline-none"
